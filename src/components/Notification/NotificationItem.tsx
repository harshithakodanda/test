...
import { TYPE_NOTIFICATION_IMAGE } from "images/Notification";
...
const NotificationItem = memo((props: NotificationItemProps) => {
  ...
  switch (props.type) {
    case NotificationEnum.ACCOUNT:
      image = TYPE_NOTIFICATION_IMAGE["account"];
      break;
    case NotificationEnum.MESSAGE:
      image = TYPE_NOTIFICATION_IMAGE["message"];
      break;
    case NotificationEnum.PAYMENT:
      image = TYPE_NOTIFICATION_IMAGE["payment"];
      break;
    case NotificationEnum.PHONE:
      image = TYPE_NOTIFICATION_IMAGE["phone"];
      break;
    case NotificationEnum.SCHEDULE:
      image = TYPE_NOTIFICATION_IMAGE["schedule"];
      break;
